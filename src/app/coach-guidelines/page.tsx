        ...
        <main className="flex-1 container mx-auto px-4 py-12 space-y-8">
          <div className="max-w-4xl mx-auto text-center space-y-4">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Everything you need to know about becoming and succeeding as a
              coach on our platform.
            </p>
          </div>
          ...
          <Tabs defaultValue="getting-started" className="space-y-6">
            ...
            <TabsContent value="getting-started" className="space-y-6">
              ...
              <div className="bg-primary text-primary-foreground p-6 rounded-lg shadow text-center">
                ...
                <p className="mb-4">
                  Apply now to join our community of expert coaches and share
                  your knowledge.
                </p>
                <Button asChild>
